...
// authentication. This script TRUNCATEs production tables by design.
const guard = require('./destructive-guard')

try {
  guard.assertDestructiveAllowed({
    operation: 'scripts/sync-db-prod.js DEV-to-PROD copy',
  ...
  console.error(
    'Refusing DEV-to-PROD database copy. Production copy is default-deny.'
  )
  process.exit(1)
}
