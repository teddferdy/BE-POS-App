...
CREATE TABLE public.goods_receipt_item (
    ...
    product integer,
    "qtyReceived" numeric(10,4) DEFAULT 0,
    unit character varying(255) DEFAULT 'pcs'::character varying,
    "conditionNotes" text,
...
CREATE TABLE public."order" (
    ...
    "serviceChargeAmount" bigint DEFAULT 0,
...
CREATE TABLE public.product_store_stock (
    ...
    product integer NOT NULL,
    store integer NOT NULL,
    stock numeric(10,4) DEFAULT 0 NOT NULL,
    "createdAt" timestamp with time zone NOT NULL,
    "updatedAt" timestamp with time zone,
    "deletedAt" timestamp with time zone,
...
CREATE TABLE public.stock_history (
    ...
    "referenceId" integer,
    "quantityBefore" numeric(10,4) DEFAULT 0,
    "quantityChange" numeric(10,4) NOT NULL,
    "quantityAfter" numeric(10,4) NOT NULL,
    unit character varying(255) DEFAULT 'pcs'::character varying,
    notes text,
    "createdBy" integer,
    "createdAt" timestamp with time zone NOT NULL,
...
CREATE TABLE public.transaction (
    ...
    "cashReceived" bigint,
    "changeGiven" bigint DEFAULT 0 NOT NULL
);
