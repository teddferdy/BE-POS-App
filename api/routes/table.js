...
router.post('/create', requireRole('super_admin', 'admin'), tableController.createTable)
router.put('/update', requireRole('super_admin', 'admin'), tableController.updateTable)
router.delete('/delete/:id', requireRole('super_admin', 'admin'), tableController.deleteTable)
