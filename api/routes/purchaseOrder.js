...
router.get('/get-all', authorization, validateStoreAccess, purchaseOrderController.getAll)
router.get('/get-by-id/:id', authorization, validateStoreAccess, purchaseOrderController.getById)
